<template>
  <v-footer height="40" app>
    ...
    >
      &copy; 2016-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">Carlos Alvarado</span>
      —
      <a
        class="text-decoration-none on-surface"
        href="https://github.com/JuanCarlosAlvaradoRucobo/Meta4_1"
        rel="noopener noreferrer"
        target="_blank"
      >
        MIT License
...
<script setup>
  const items = [
    ...
    },
    {
      ...
      href: 'https://discord.gg/b4w39nxF',
    },
    {
      title: 'Alvarado Reddit',
      icon: `mdi-reddit`,
